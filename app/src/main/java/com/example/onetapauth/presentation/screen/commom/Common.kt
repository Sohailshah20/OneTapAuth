package com.example.onetapauth.presentation.screen.commom
...
import com.example.onetapauth.util.Constants.CLIENT_ID
        ...
        try {
            ...
            when(e.statusCode){
                CommonStatusCodes.CANCELED ->{
                    Log.d("StartActivityForResult","CANCELLED")
                    onDialogDismissed()
                }
                CommonStatusCodes.NETWORK_ERROR ->{
                    Log.d("StartActivityForResult","NETWORK ERROR")
                    onDialogDismissed()
                }
                else ->{
